...
job. Note that the \verb;self; layer (for loopback communication) and the
\verb;sm; layer (shared memory, for local communication) must always be
specified.

\begin{figure}
\centering
\begin{verbatim}
mpirun -n 16 -host xu0,xu1,xu2,xu3 --mca btl tcp,self,sm <MPI job>
mpirun -n 16 -host xu0,xu1,xu2,xu3 --mca btl openib,self,sm <MPI job>
\end{verbatim}
...
our ARM cluster. \textbf{Figure \ref{costperf}} shows the performance-for-cost comparison
